...
export default class Home extends Component {
  ...
  render() {
    ...
    const scqs = [
      {
        ...
        width: 160,
        render: (text, record) => {
          return (<a target="_blank" href={`/cm/gsjd/deal/${record.bmsah}`}>{text}</a>)
        }
      }, {
        title: '承办人',
        dataIndex: 'cbrxm',
        ...
        children: [{
          ...
          children: [{
            ...
            render: (text, record) => (
              <span>
                <BjModal title="工作笔记二级表" record={record}  {...ModelList}>
                  <a>{text}</a>
                </BjModal>
              </span>),
          }],
        ...
        children: [{
          ...
          children: [{
            ...
            render: (text, record) => (
              <span>
                <ZjModal title="侦查监督及回复二级表" record={record} {...ModelList} sel="5">
                  <a>{text}</a>
                </ZjModal>
              </span>),
          }],
          ...
          children: [{
            ...
            render: (text, record) => (
              <span>
                <ZjModal title="侦查监督及回复二级表" record={record} {...ModelList} sel="6">
                  <a>{text}</a>
                </ZjModal>
              </span>),
          }],
          ...
          children: [{
            ...
            render: (text, record) => (
              <span>
                <ZjModal title="侦查监督及回复二级表" record={record} {...ModelList} sel="7">
                  <a>{text}</a>
                </ZjModal>
              </span>),
          }],
          ...
          children: [{
            ...
            render: (text, record) => (
              <span>
                <ZjModal title="侦查监督及回复二级表" record={record} {...ModelList} sel="8">
                  <a>{text}</a>
                </ZjModal>
              </span>),
          }],
    ...
    const ColumnsData = {title: '刑事办案智能辅助系统案件查询表（审查起诉）', columns: scqs, scroll: 1870};
    const MainList = {
      dispatch,
      list,
      pagination,
